...
export function TileLayout({ chatOpen }: TileLayoutProps) {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-6 sm:top-8 bottom-28 sm:bottom-32 z-50 md:top-12 md:bottom-40 md:right-80 lg:right-96">
      <div className="relative mx-auto h-full max-w-2xl px-3 sm:px-4 md:px-0">
